          ...
          <div className="row">
            ...
            <div className=" col-12 col-md-4">
              <Input
                ...
                onChange={(e) => {
                  setBooksData({ ...booksData, publisher: e.target.value });
                }}
                name={"data"}
                title={publisher}
                disabled={disabled}
            ...
            <div className="col-12 col-md-4">
              <Input
                ...
                onChange={(e) => {
                  setBooksData({ ...booksData, language: e.target.value });
                }}
                name={"data"}
                title={language}
                disabled={disabled}
            ...
            <div className="col-12 col-md-4">
              <Input
                ...
                onChange={(e) => {
                  setBooksData({ ...booksData, image: e.target.value });
                }}
                name={"data"}
                title={image}
                disabled={disabled}
            ...
            <div className="col-12 col-md-4">
              <Input
                ...
                placeholder={price}
                onChange={(e) => {
                  setBooksData({ ...booksData, price: e.target.value });
                }}
                name={"data"}
                title={price}
                disabled={disabled}
            ...
            <div className="col-12 col-md-4">
              <Input
                ...
                onChange={(e) => {
                  setBooksData({ ...booksData, borrowBy: e.target.value });
                }}
                name={"data"}
                title={borrowBy}
                disabled={disabled}
            ...
            <div className="col-12 col-md-4">
              <Input
                ...
                onChange={(e) => {
                  setBooksData({ ...booksData, returnDate: e.target.value });
                }}
                name={"data"}
                title={returnDate}
                disabled={disabled}
