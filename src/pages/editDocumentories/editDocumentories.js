...
function EditDocumentories() {
  ...
  const [_id ,title , director, description, publishedDate, borrowedBy, borrowDate, expectedDateReturn,genre,borrow] = Object.keys(data);         
    ...
    <div className="col-12 col-md-8">
        ...
        <div className="col-12 col-md-4">
              <Input
                ...
                onChange={(e)=>{setBooksData({...booksData, director:e.target.value})}}
                name={"data"}
                title={director}
                disabled ={disabled}
                type="date"
        ...
        <div className="col-12 col-md-4">
              <Input
                ...
                onChange={(e)=>{setBooksData({...booksData, borrowedBy:e.target.value})}}
                name={"data"}
                title={borrowedBy}
                disabled ={disabled}
                type="text"
        ...
        <div className="col-12 col-md-4">
              <Input
                ...
                onChange={(e)=>{setBooksData({...booksData, expectedDateReturn:e.target.value})}}
                name={"data"}
